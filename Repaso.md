...
Costos
Cuadno se excede el precio de un servicio podemos usar las alertas para conocer el limite
...
el hecho de combinarlos da como resultado un número total que es _inferior_ al 99,9 % que necesita. ¿Por qué? Porque el uso de varios servicios agrega un nivel de complejidad adicional y aumenta ligeramente el riesgo de que se produzcan errores.

Para poder aumentar el SLA podemos implementar una o más instancias adicionales de la misma máquina virtual en las diferentes zonas de disponibilidad de una misma región de Azure.